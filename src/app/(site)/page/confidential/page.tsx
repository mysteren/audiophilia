...
export function metadata() {
  const title = "Политики конфиденциальносты";
  const description = "";
  const canonical = "/page/confidential";
  return {
    title,
    description,
    alternates: {
...
export default function СonfidentialPage() {
  return (
    <>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые ООО Инвест Сталь
        (далее – Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта https://investsteel.ru
      </p>
      ...
      <p>
        ...
        сети интернет по сетевому адресу https://investsteel.ru.
      </p>
      <p>
      ...
      <p>
        2.10. Пользователь – любой посетитель веб-сайта https://investsteel.ru.
      </p>
      <p>
      ...
      <p>
        ...
        материалам, содержащимся на веб-сайте https://investsteel.ru.
      </p>
      <p>
        ...
        почты info@investsteel.ru с пометкой «Отказ от уведомлений о новых
      ...
      <p>
        ...
        связана с информационными технологиями, в частности с созданием сайтов,
        то здесь можно указать Федеральный закон "Об информации, информационных
      ...
      <p>
        ...
        специальные формы, расположенные на сайте https://investsteel.ru или
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора info@investsteel.ru с
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора info@investsteel.ru с
      ...
      <p>
        ...
        Оператору с помощью электронной почты info@investsteel.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://investsteel.ru/politika-konfidenczialnosti.
      </p>
    </>
  );
}
